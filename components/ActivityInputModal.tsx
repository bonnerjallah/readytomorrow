// 🌱 ROOT IMPORTS
import { StyleSheet, Text, View, Modal, TouchableOpacity, Alert, Animated, Easing, Switch, TouchableWithoutFeedback, Platform } from 'react-native'
...
const ActivityInputModal = ({ isVisible, onClose }: ActivityInputModalProps) => {
  ...
  const dropdownHeights = [350, 240, 350]; // target heights for each dropdown
                ...
                <Animated.View style={{ height: dropdowns[1].height, opacity: dropdowns[1].opacity, overflow:"hidden" }}>
                  <View style={{borderTopWidth: 0.2}}>
                    ...
                    <View style={{flexDirection:"row", justifyContent:"space-between"}}>
                      <TouchableOpacity style={[styles.timeOfDaySelector, {backgroundColor:theme.dropdownBackground}]}>
                        <ThemedText variant='smallertitle'>Morning</ThemedText>
                      </TouchableOpacity>
                      <TouchableOpacity style={[styles.timeOfDaySelector, {backgroundColor:theme.dropdownBackground}]}>
                        <ThemedText variant='smallertitle'>Afternoon</ThemedText>
                      </TouchableOpacity>
                      <TouchableOpacity style={[styles.timeOfDaySelector, {backgroundColor:theme.dropdownBackground}]}>
                        <ThemedText variant='smallertitle'>Evening</ThemedText>
                      </TouchableOpacity>
                    </View>
